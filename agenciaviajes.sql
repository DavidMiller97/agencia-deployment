...
--
-- Table structure for table `testimoneales`
--

DROP TABLE IF EXISTS `testimoneales`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `testimoneales` (
...
--
-- Dumping data for table `testimoneales`
--

LOCK TABLES `testimoneales` WRITE;
/*!40000 ALTER TABLE `testimoneales` DISABLE KEYS */;
INSERT INTO `testimoneales` VALUES (1,'David','david@gmail.com','Las mejores vacaciones'),(2,'David','david@gmail.com','Las mejores vacaciones');
/*!40000 ALTER TABLE `testimoneales` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-11-25 14:15:11
